...
// UART
#define rULCON(n)     (*(volatile unsigned *)(0x50000000 + 0x4000 * (n)))	//UART Line control
#define rUCON(n)      (*(volatile unsigned *)(0x50000004 + 0x4000 * (n)))	//UART Control
#define rUFCON(n)     (*(volatile unsigned *)(0x50000008 + 0x4000 * (n)))	//UART FIFO control
#define rUMCON(n)     (*(volatile unsigned *)(0x5000000c + 0x4000 * (n)))	//UART Modem control
#define rUTRSTAT(n)   (*(volatile unsigned *)(0x50000010 + 0x4000 * (n)))	//UART Tx/Rx status
#define rUERSTAT(n)   (*(volatile unsigned *)(0x50000014 + 0x4000 * (n)))	//UART Rx error status
#define rUFSTAT(n)    (*(volatile unsigned *)(0x50000018 + 0x4000 * (n)))	//UART FIFO status
#define rUMSTAT(n)    (*(volatile unsigned *)(0x5000001c + 0x4000 * (n)))	//UART Modem status
#define rUBRDIV(n)    (*(volatile unsigned *)(0x50000028 + 0x4000 * (n)))	//UART Baud rate divisor

#ifdef __BIG_ENDIAN
#define rUTXH(n) (*(volatile unsigned char *)(0x50000023 + 0x4000 * (n)))	//UART Transmission Hold
#define rURXH(n) (*(volatile unsigned char *)(0x50000027 + 0x4000 * (n)))	//UART Receive buffer
#else //Little Endian
#define rUTXH(n) (*(volatile unsigned char *)(0x50000020 + 0x4000 * (n)))	//UART Transmission Hold
#define rURXH(n) (*(volatile unsigned char *)(0x50000024 + 0x4000 * (n)))	//UART Receive buffer
#endif	// __BIG_ENDIAN
